...
export const initializeGameFolder = (panel: GUI, game: GameObject, player: PlayerObject): void => {
...
export const initializePlayerFolder = (panel: GUI, player: PlayerObject): void => {
